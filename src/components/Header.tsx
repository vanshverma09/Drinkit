...
import { useAddressStore, savedAddresses } from "@/store/address";
    ...
    <>
          ...
          <div className="flex items-center justify-between gap-3 mb-3">
            ...
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              ...
              <button 
                ...
                className="flex items-center gap-1 min-w-0 group text-left"
              >
                <MapPin
                  size={18}
      ...
      >
        <div className="flex flex-col gap-4">
          <button className="flex items-center gap-2 text-primary font-medium text-sm py-2">
              ...
              >
                <input 
                  ...
                  onChange={() => {
                    ...
                    setTimeout(() => setIsAddressModalOpen(false), 200);
                  }}
